...
public class Address extends TestCase {
    ...
    public void testParseWithMissingEmail() {
        com.tbs.mailer.mail.Address[] addresses =  com.tbs.mailer.mail.Address.parse("NAME ONLY");
    ...
    public void testPraseWithValidEmail() {
        com.tbs.mailer.mail.Address[] addresses =  com.tbs.mailer.mail.Address.parse("Max Mustermann <maxmuster@mann.com>");
        assertEquals(1, addresses.length);
    ...
    public void testPraseWithValidEmailMulti() {
        com.tbs.mailer.mail.Address[] addresses =  com.tbs.mailer.mail.Address.parse("lorem@ipsum.us,mark@twain.com");
